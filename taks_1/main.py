...
client = MongoClient(
    "mongodb+srv://PRIVATE:PRIVATE.zifz1la.mongodb.net/PRIVATE?retryWrites=true&w=majority&appName=ClusterMain"
)
...
cats = [
    ...
    {"name": "pushok", "age": 2, "features": ["пухнастий", "сірий", "дуже гучний"]},
    {
        "name": "simba",
        "age": 1,
        "features": ["рудий", "дуже активний", "любит гратись"],
    },
    {"name": "leopold", "age": 6, "features": ["старий", "мудрий", "повільний"]},
]
